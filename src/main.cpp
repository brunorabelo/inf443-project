...
int main(int, char *argv[]) {
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        helper_common.frame_begin(scene.environment.background_color, window, scene.inputs.window,
                                  scene.inputs.mouse.on_gui);
...
GLFWwindow *standard_window_initialization(int width_target, int height_target) {
    ...
    glfwSetMouseButtonCallback(window,
                               mouse_click_callback); // Event called when a button of the mouse is clicked/released
